...
class Particles:
    ...
    def compare(self, that, atol=1e-12):
        return compare_particles(self, that)
...
def all_assert_sorted(part1, part2, atol=1e-12):
    ...
    np.testing.assert_allclose(part1.v[idx1, 0], part2.v[idx2, 0], atol=atol)
    np.testing.assert_allclose(part1.v[idx1, 1], part2.v[idx2, 1], atol=atol)
    np.testing.assert_allclose(part1.v[idx1, 2], part2.v[idx2, 2], atol=atol)
