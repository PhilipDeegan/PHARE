...
class DataWrangler:
    ...
    def __init__(self, simulator):
        ...
        cpp_str = "DataWrangler_" + str(self.dim) + "_" + str(self.interp)+ "_" + str(self.refined_particle_nbr) + "_" + cpp_float_str
        self.cpp = getattr(cpp, cpp_str)(simulator.cpp_sim, simulator.cpp_hier)
