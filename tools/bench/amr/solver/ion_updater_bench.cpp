...
static std::vector<std::int64_t> PPC{5, 8, 10, 20, 50, 100, 200, 400};
static std::vector<std::int64_t> CELLS{1, 2, 3, 4, 5, 10, 15, 20, 35, 50, 100};
