...
public:
    ...
    auto getRho() { return this->getField(this->model.state.rho); }
    auto getP() { return this->getField(this->model.state.P); }
    auto getEtot() { return this->getField(this->model.state.Etot); }

    auto getV(std::string const& component)
    {
        return this->getVecFieldComponent(this->model.state.V, this->vecfield_component(component));
    }
    auto getB(std::string const& component)
    {
        return this->getVecFieldComponent(this->model.state.B, this->vecfield_component(component));
    }
    auto getRhoV(std::string const& component)
    {
        return this->getVecFieldComponent(this->model.state.rhoV,
                                          this->vecfield_component(component));
    }
    auto getE(std::string const& component)
    {
        return this->getVecFieldComponent(this->model.state.E, this->vecfield_component(component));
    }
    auto getJ(std::string const& component)
    {
        return this->getVecFieldComponent(this->model.state.J, this->vecfield_component(component));
    }
};
