...
// Free functions: neither of these touches a model instance at all - only the passed
// GridLayout (and its ::dimension) - so callers with a GridLayout in hand never need to
// resolve "which model view" first just to build patch attributes.
template<typename GridLayout>
NO_DISCARD auto getPatchProperties(std::string patchID, GridLayout const& grid)
{
...
NO_DISCARD inline auto getEmptyPatchProperties(PatchProperties dict = {})
{
