...
namespace amr
{
     ...
     */
    template<typename core_types, typename Attempt = void>
    struct has_ions : std::false_type
    {
    };
    template<typename core_types>
    struct has_ions<core_types, core::tryToInstanciate<typename core_types::Ions_t>>
        : std::true_type
    {
    };
    template<typename core_types>
    bool constexpr static has_ions_v = has_ions<core_types>::value;
