...
{
    PHARE_LOG_SCOPE(3, "FieldBorderSumTransaction::canEstimateIncomingMessageSize");
...
{
    PHARE_LOG_SCOPE(3, "FieldBorderSumTransaction::computeIncomingMessageSize");
...
{
    PHARE_LOG_SCOPE(3, "FieldBorderSumTransaction::computeOutgoingMessageSize");
...
{
    PHARE_LOG_SCOPE(3, "FieldBorderSumTransaction::getSourceProcessor");
...
{
    PHARE_LOG_SCOPE(3, "FieldBorderSumTransaction::getDestinationProcessor");
...
{
    PHARE_LOG_SCOPE(3, "FieldBorderSumTransaction::packStream");
...
void FieldBorderSumTransaction<SrcFieldData_t, DstFieldData_t>::unpackStream(
    SAMRAI::tbox::MessageStream& stream)
{
    PHARE_LOG_SCOPE(3, "FieldBorderSumTransaction::unpackStream");
...
{
    PHARE_LOG_SCOPE(3, "FieldBorderSumTransaction::printClassData");
...
{
    PHARE_LOG_SCOPE(3, "FieldBorderSumTransaction::copyLocalData");
    assert(this);
...
public:
             ...
             SAMRAI::hier::Box const& box, bool use_time_interpolation) const override
    {
        ...
        PHARE_LOG_SCOPE(3, "FieldBorderSumTransactionFactory::allocate");
    ...
    {
        PHARE_LOG_SCOPE(3, "FieldBorderSumTransactionFactory::preprocessScratchSpace");
