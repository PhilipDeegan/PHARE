...
{
    // std::shared_ptr<SAMRAI::pdat::OuternodeData<double>> onode_dst_data(
    //     SAMRAI_SHARED_PTR_CAST<SAMRAI::pdat::OuternodeData<double>, SAMRAI::hier::PatchData>(
...
void FieldBorderSumTransaction<FieldData_t>::copyLocalData()
{
    ...
    //     std::shared_ptr<SAMRAI::pdat::OuternodeData<double>> onode_src_data(
    //         SAMRAI_SHARED_PTR_CAST<SAMRAI::pdat::OuternodeData<double>, SAMRAI::hier::PatchData>(
    //             d_src_level->getPatch(d_src_node.getGlobalId())
    //                 ->getPatchData(d_refine_data[d_item_id]->d_src)));
