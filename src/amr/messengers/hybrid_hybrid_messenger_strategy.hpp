...
namespace amr
{
    ...
    private:
        ...
        using TensorFieldGhostSumRefinerPool
            = RefinerPool<rm_t, RefinerType::PatchTensorFieldBorderSum>;
        using FieldFillPattern_t = FieldFillPattern<dimension>;

        //! += flux on ghost box overlap incomplete population moment nodes
        std::vector<TensorFieldGhostSumRefinerPool> popFluxBorderSumRefiners_;
