...
namespace amr
{
    ...
    class HybridHybridMessengerStrategy : public HybridMessengerStrategy<HybridModel>
    {
        ...
        using FieldBorderSumTransactionFactory_t
            = FieldBorderOpTransactionFactory<FieldDataT, PlusEqualsOp, FieldData_t>;
        using VecFieldBorderSumTransactionFactory_t
            = FieldBorderOpTransactionFactory<VectorFieldDataT, PlusEqualsOp, VectorFieldData_t>;
        using TensorFieldBorderSumTransactionFactory_t
            = FieldBorderOpTransactionFactory<TensorFieldDataT, PlusEqualsOp, TensorFieldData_t>;

        using FieldBorderMaxTransactionFactory_t
            = FieldBorderOpTransactionFactory<FieldDataT, SetMaxOp, FieldData_t>;
        using VecFieldBorderMaxTransactionFactory_t
            = FieldBorderOpTransactionFactory<VectorFieldDataT, SetMaxOp, VectorFieldData_t>;
