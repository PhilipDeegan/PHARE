...
#ifndef PHARE_AMR_DATA_PARTICLES_EXPORTING_DETAIL_DEF_EXPORTING
#define PHARE_AMR_DATA_PARTICLES_EXPORTING_DETAIL_DEF_EXPORTING
...
#endif /* PHARE_AMR_DATA_PARTICLES_EXPORTING_DETAIL_DEF_EXPORTING */
