...
namespace amr
{
    ...
    public:
                  ...
                  SAMRAI::hier::BoxOverlap const& overlap) override
        {
            ...
            {
                copy_from_ghost(pSource, *casted);
                return;
            }
            // else
                        ...
                        SAMRAI::hier::BoxOverlap const& overlap) const override
        {
            ...
            using PackArray = core::ParticleArray<
                dim, core::ParticleArrayInternals<dim, core::base_layout_type<ParticleArray>()>>;
                          ...
                          SAMRAI::hier::BoxOverlap const& overlap) override
        {
            ...
            if constexpr (ParticleArray::is_mapped)
                unpackMappedParticles(stream, overlap);
            else
                unpackAnyParticles(stream, overlap);
        }
...
void ParticlesData<ParticleArray_t>::unpackAnyParticles(SAMRAI::tbox::MessageStream& stream,
                                                        SAMRAI::hier::BoxOverlap const& overlap)
{
    using UnpackArray = core::ParticleArray<
        dim, core::ParticleArrayInternals<dim, core::base_layout_type<ParticleArray_t>()>>;
