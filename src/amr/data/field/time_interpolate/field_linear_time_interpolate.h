...
public:
                         ...
                         SAMRAI::hier::PatchData const& srcDataNew) const override
    {
        ...
        else if constexpr (dim == 2)
        {
            ...
            auto const iDestStartY = localDestBox.lower(dirY) - 1;
            auto const iDestEndY   = localDestBox.upper(dirY) + 1;

            auto const iSrcStartX = localSrcBox.lower(dirX) - 1;
            auto const iSrcStartY = localSrcBox.lower(dirY) - 1;
        ...
        else if constexpr (dim == 3)
        {
            ...
            auto const iDestStartY = localDestBox.lower(dirY) - 1;
            auto const iDestEndY   = localDestBox.upper(dirY) + 1;
            auto const iDestStartZ = localDestBox.lower(dirZ) - 1;
            auto const iDestEndZ   = localDestBox.upper(dirZ) + 1;

            auto const iSrcStartX = localSrcBox.lower(dirX) - 1;
            auto const iSrcStartY = localSrcBox.lower(dirY) - 1;
            auto const iSrcStartZ = localSrcBox.lower(dirZ) - 1;
