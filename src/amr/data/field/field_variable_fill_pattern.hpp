...
public:
                     ...
                     SAMRAI::hier::Transformation const& transformation) const override
    {
        ...
        FieldGeometry_t const& src_geometry = FieldGeometry_t::CAST_FROM(_src_geometry);
        FieldGeometry_t const& dst_geometry = FieldGeometry_t::CAST_FROM(_dst_geometry);
        ...
        auto const src_ghost_box = [&]() {
            ...
            return core::shift(primal_ghost_box, as_point<dim>(transformation));
        }();
