...
class MagneticFieldRefiner : public AnyFieldRefiner<MagneticFieldRefiner<dimension>, dimension>
{
public:
    using Super = AnyFieldRefiner<MagneticFieldRefiner<dimension>, dimension>;
    using Super::Super;
