...
class ElectricFieldRefiner : public AnyFieldRefiner<ElectricFieldRefiner<dimension>, dimension>
{
public:
    using Super = AnyFieldRefiner<ElectricFieldRefiner<dimension>, dimension>;
    using Super::Super;
...
public:
    ...
    void refine(FieldT const& coarseField, FieldT& fineField, core::Point<int, dimension> fineIndex)
    {
                   ...
                   core::Point<int, dimension> const& locCoarseIdx)
    {
                 ...
                 and centerings_[dirY] == core::QtyCentering::primal)
        {
            ...
            else
            {
                if (auto& fineVal = fineField(locFineIdx); std::isnan(fineVal))
                    fineVal = 0.25
                              * (coarseField(locCoarseIdx) + coarseField(ilcx + 1, ilcy)
                   ...
                   core::Point<int, dimension> const& locCoarseIdx)
    {
            ...
            and centerings_[dirZ] == core::QtyCentering::primal)
        {
            ...
            else
            {
                ...
                if (auto& fineVal = fineField(locFineIdx); std::isnan(fineVal))
                    fineVal = 0.25 * (coarseField(locCoarseIdx) + coarseField(ilcx, ilcy + 1, ilcz))
                              + 0.25
                 ...
                 and centerings_[dirZ] == core::QtyCentering::primal)
        {
            ...
            else
            {
                if (auto& fineVal = fineField(locFineIdx); std::isnan(fineVal))
                    fineVal = 0.25
                              * (coarseField(locCoarseIdx) + coarseField(ilcx + 1, ilcy, ilcz)
                                 + coarseField(ilcx, ilcy, ilcz + 1)
