...
public:
    ...
    using GridLayout_t = HybridModel_t::gridlayout_type;
...
struct HybridPPCModelView<HybridModel>::PatchState_t
{
    ...
    std::string patchID() const { return core::to_string(patch->getGlobalId()); }
