...
public:
    ...
    using vector_type = SoAParticles<SoAVector<dimension>>;
...
public:
    ...
    // // full adds E/B to the tuple, flat turns any vector<array> to span
    // auto as_tuple()
    // {
    //     if constexpr (flat)
    //     {
...
template<std::size_t dim>
using SoAVectorParticles = SoAParticles<SoAVector<dim>>;
