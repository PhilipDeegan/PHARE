...
public:
    ...
    template<typename Src>
    void append(Src const& src, std::size_t const start, std::size_t size)
    {
...
public:
    ...
    // AoSMappedParticles(AoSMappedParticles const& from)
    //     : Super{from}
    //     , box_{from.box_}
    //     , cellMap_{from.cellMap_}
    // {
    //     empty_map();     // new particles
    //     map_particles(); // if vector?
    // }


    AoSMappedParticles(AoSMappedParticles const& from)            = default;
    AoSMappedParticles(AoSMappedParticles&& from)                 = default;
    AoSMappedParticles& operator=(AoSMappedParticles&& from)      = default;
    AoSMappedParticles& operator=(AoSMappedParticles const& from) = default;

    // AoSMappedParticles& operator=(AoSMappedParticles const& that)
    // {
    //     static_cast<Super&>(*this) = static_cast<Super const&>(that);
    //     this->box_                 = that.box_;
    ...
    // AoSMappedParticles& operator=(AoSMappedParticles&& that)
    // {
    //     static_cast<Super&>(*this) = std::move(static_cast<Super&&>(that));
    //     this->box_                 = that.box_;
    //     this->cellMap_             = that.cellMap_; // = std::move(that.cellMap_) // == bug?
    //     return *this;
    // }
