#ifndef PHARE_CORE_DATA_PARTICLES_PARTICLE_ARRAY_PerCellPRO_HPP
#define PHARE_CORE_DATA_PARTICLES_PARTICLE_ARRAY_PerCellPRO_HPP
...
auto& PerCellVector<Particles, impl>::reserve_ppc(std::size_t const& ppc)
{
    ...
    std::size_t const additional = ppc < 10 ? 5 : ppc * .2; // 20% overallocate
...
template<typename Super_>
template<typename T>
struct PerCellParticles<Super_>::index_wrapper
{
...
#endif /* PHARE_CORE_DATA_PARTICLES_PARTICLE_ARRAY_PerCellPRO_HPP */
