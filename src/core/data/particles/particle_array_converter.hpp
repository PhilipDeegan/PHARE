...
template<auto layout_mode, std::size_t D, typename I0, typename GridLayout>
auto convert_to(ParticleArray<D, I0> const& src, GridLayout const& layout)
{
    using Parts = ParticleArray<
        D, ParticleArrayInternals<D, layout_mode, StorageMode::VECTOR, I0::alloc_mode>>;
