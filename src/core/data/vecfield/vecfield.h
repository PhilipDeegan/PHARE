...
public:
    ...
    {
        using data_view_t = typename Field::data_view_t;
        return {field_type{data_view_t{vecfield[0].data(), vecfield[0].shape()},
                           vecfield[0].physicalQuantity()},
                field_type{data_view_t{vecfield[1].data(), vecfield[1].shape()},
                           vecfield[1].physicalQuantity()},
                field_type{data_view_t{vecfield[2].data(), vecfield[2].shape()},
                           vecfield[2].physicalQuantity()}};
    }
