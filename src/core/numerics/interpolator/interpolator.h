...
namespace core
{
    ...
    int computeStartIndex(double normalizedPos) _PHARE_ALL_FN_
    {
    ...
    public:
        ...
        inline double operator()(Field const& field,
                                 ...
                                 Array1 const& startIndex, Array2 const& weights) _PHARE_ALL_FN_
        {
    ...
    public:
        ...
        auto indexAndWeight(Particle_t const& part, GridLayout const& layout) _PHARE_ALL_FN_
        {
