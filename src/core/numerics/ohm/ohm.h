...
struct StandardOhmComputer
{
    ...
    auto ideal1D_(VecField const& Ve, VecField const& B, MeshIndex<1> index,
                  ComponentTag) const _PHARE_ALL_FN_
    {
    ...
    template<typename VecField, typename ComponentTag>
    auto ideal2D_(VecField const& Ve, VecField const& B, MeshIndex<2> index,
                  ComponentTag) const _PHARE_ALL_FN_
    {
        if constexpr (ComponentTag::component == Component::X)
        {
    ...
    template<typename VecField, typename ComponentTag>
    auto ideal3D_(VecField const& Ve, VecField const& B, MeshIndex<3> index,
                  ComponentTag) const _PHARE_ALL_FN_
    {
        if constexpr (ComponentTag::component == Component::X)
        {
    ...
    auto ideal_(VecField const& Ve, VecField const& B, MeshIndex<dimension> index,
                ComponentTag tag) const _PHARE_ALL_FN_
    {
    ...
    template<typename VecField, typename ComponentTag>
    auto resistive_(VecField const& J, MeshIndex<VecField::dimension> index,
                    ComponentTag) const _PHARE_ALL_FN_
    {
        if constexpr (ComponentTag::component == Component::X)
        {
    ...
    void exyz(OhmPack&& pack, IDXs const&... ijk) const _PHARE_ALL_FN_
    {
