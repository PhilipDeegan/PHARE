...
struct StandardAmpereComputer
{
    ...
    void Jx(Field& Jx, VecField const& B, Indexes const&... ijk) const _PHARE_ALL_FN_
    {
    ...
    template<typename VecField, typename Field, typename... Indexes>
    void Jy(Field& Jy, VecField const& B, Indexes const&... ijk) const _PHARE_ALL_FN_
    {
    ...
    template<typename VecField, typename Field, typename... Indexes>
    void Jz(Field& Jz, VecField const& B, Indexes const&... ijk) const _PHARE_ALL_FN_
    {
        auto const& [Bx, By, Bz] = B();
