...
struct UpdaterSelectionBoxing
{
    ...
    bool isInLevelGhostBox(auto& particle) const { return !isIn(particle, nonLevelGhostBox); };
    bool isInNonLevelGhostBox(auto& particle) const { return isIn(particle, nonLevelGhostBox); };
