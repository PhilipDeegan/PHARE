...
template<typename GL, typename ND, typename PQ, typename Fn>
void transform(FieldTileSet<GL, ND, PQ> const& in, FieldTileSet<GL, ND, PQ>& out, Fn const fn)
{
...
void transform(FieldTileSet<GL, ND, PQ> const& in0, FieldTileSet<GL, ND, PQ> const& in1,
               FieldTileSet<GL, ND, PQ>& out, Fn const fn)
{
