#ifndef PHARE_CORE_UTILITITES_RANGES_H
#define PHARE_CORE_UTILITITES_RANGES_H
...
auto make_balanced_ranges(Container& container, std::size_t split = 10,
                          ...
                          Builder builder = Defaults::builder, std::size_t range_size = 1e7)
{
    ...
    auto load_ranges = [&](auto const t_idx, auto const size) {
        ...
        do
        {
            ...
            for (auto& range : ranges(arr, range_size, offset))
            {
...
#endif // PHARE_CORE_UTILITITES_RANGES_H
