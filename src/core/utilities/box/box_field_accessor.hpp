#ifndef PHARE_CORE_UTILITIES_BOX_BOX_FIELD_ACCESSOR_HPP
#define PHARE_CORE_UTILITIES_BOX_BOX_FIELD_ACCESSOR_HPP
...
struct BoxRow
{
    auto static constexpr dim = Array_t::dimension;
...
template<typename Array_t>
BoxSpan(Box<std::uint32_t, Array_t::dimension> box, Array_t& arr) -> BoxSpan<Array_t>;


} // namespace PHARE::core

#endif // PHARE_CORE_UTILITIES_BOX_BOX_FIELD_ACCESSOR_HPP
