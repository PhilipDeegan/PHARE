...
diag_outputs = "phare_outputs/test/helmholtz/2d"
time_step_nbr = 50000
time_step = 0.005
...
def plot_file_for_qty(plot_dir, qty, time):
    return f"{plot_dir}/helmholtz_{qty}_t{time}.png"


class HelmholtzTest(SimulatorTest):
    def __init__(self, *args, **kwargs):
        super(HelmholtzTest, self).__init__(*args, **kwargs)
        self.simulator = None

    def tearDown(self):
        super(HelmholtzTest, self).tearDown()
