...
{
    using ParticlesVariable_t = ParticlesVariable<ParticleArray<double, dimension>, interpOrder>;
...
public:
    ...
    explicit BasicHierarchy(int _ratio)
        ...
        , refineOperator_{std::make_shared<
              ParticlesRefineOperator<ParticleArray<double, dimension>, splitType,
