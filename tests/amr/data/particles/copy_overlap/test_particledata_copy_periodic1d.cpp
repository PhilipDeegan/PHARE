...
struct twoParticlesDatasTouchingPeriodicBorders : public testing::Test
{
    ...
    ParticlesData<ParticleArray<double, 1>> destPdat{destDomain, ghost};
    ParticlesData<ParticleArray<double, 1>> sourcePdat{sourceDomain, ghost};
