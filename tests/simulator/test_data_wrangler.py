...
class DataWranglerTest(unittest.TestCase):
    ...
    def test_1d(self):
        ...
        hier = None
        hier = hierarchy_from_sim(self.simulator, qty=f"EM_B_x", hier=hier, sync=True)
        hier = hierarchy_from_sim(self.simulator, qty=f"EM_B_y", hier=hier, sync=True)
        hier = hierarchy_from_sim(self.simulator, qty=f"density", hier=hier, sync=True)
