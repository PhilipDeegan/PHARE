...
from pyphare.pharein import ElectronModel, DeterministicFluidModel
...
class AdvanceTestBase(SimulatorTest):
    ...
    def test_domain_particles_on_refined_level(self):
        self._test_domain_particles_on_refined_level(1, 1, {"L0": {"B0": Box1D(10, 14)}})
