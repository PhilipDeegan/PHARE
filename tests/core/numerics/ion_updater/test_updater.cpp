...
TYPED_TEST(IonUpdaterTest, particlesUntouchedInMomentOnlyMode)
{
    ...
    checkIsUnTouched(populations[0].patchGhostParticles(), cpy_pops[0].patchGhostParticles());
    ...
    checkIsUnTouched(populations[1].patchGhostParticles(), cpy_pops[1].patchGhostParticles());
