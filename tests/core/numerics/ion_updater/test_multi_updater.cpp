...
auto static const seed      = get_env_as("PHARE_SEED", std::size_t{1013});
auto static const n_patches = get_env_as("PHARE_PATCHES", std::size_t{4});
...
struct IonUpdaterPPTest : public ::testing::Test
{
    ...
    struct Patch
    {
        ...
        using GridLayout_t       = GridLayout_t;
