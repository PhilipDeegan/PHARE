...
TYPED_TEST(PusherTest, doesMoveParticles)
{
    ...
    auto constexpr static field_sim_opts = PHARE::SimOpts{
        .dimension = dim, .interp_order = interp, .alloc_mode = ParticleArray_t::alloc_mode};
    using Hybrid_t                   = PHARE::core::PHARE_Types<field_sim_opts>::Hybrid;
