...
{
    using ParticleArray_t = ParticleArray<Particle<dim>>;
...
{
    using ParticleArray_t = ParticleArray<Particle<1>>;
...
{
    auto pusher = PusherFactory::makePusher<1, ParticleArray<Particle<1>>::iterator, Electromag,
