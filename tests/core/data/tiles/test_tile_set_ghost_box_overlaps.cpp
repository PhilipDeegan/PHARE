...
struct TestParam
{
    ...
    auto static constexpr opts        = SimOpts{.dimension    = dim,
                                                .interp_order = interp,
...
auto patch_ghost_copy(TileSetTest_t& self)
{
    ...
    auto constexpr static nbrGhosts = GridLayout_t::options.particle_ghost_width;
...
{
    using GridLayout_t               = TileSetTest_t::GridLayout_t;
    using Hybrid_t                   = TileSetTest_t::PhareTypes::Hybrid;
    auto constexpr static field_opts = TensorFieldOptions<Hybrid_t>{};
    using UsableVecField_t           = UsableVecField<field_opts>;
    auto constexpr static nbrGhosts  = GridLayout_t::options.field_ghost_width;
