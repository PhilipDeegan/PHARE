...
using GridLayoutTestYeeIndexing1DO1 = GridLayoutTest<PHARE::SimOpts{1, 1}, GridLayoutIndexingParam>;
using GridLayoutTestYeeIndexing1DO2 = GridLayoutTest<PHARE::SimOpts{1, 2}, GridLayoutIndexingParam>;
using GridLayoutTestYeeIndexing1DO3 = GridLayoutTest<PHARE::SimOpts{1, 3}, GridLayoutIndexingParam>;


using GridLayoutTestYeeIndexing2DO1 = GridLayoutTest<PHARE::SimOpts{2, 1}, GridLayoutIndexingParam>;
using GridLayoutTestYeeIndexing2DO2 = GridLayoutTest<PHARE::SimOpts{2, 2}, GridLayoutIndexingParam>;
using GridLayoutTestYeeIndexing2DO3 = GridLayoutTest<PHARE::SimOpts{2, 3}, GridLayoutIndexingParam>;


using GridLayoutTestYeeIndexing3DO1 = GridLayoutTest<PHARE::SimOpts{3, 1}, GridLayoutIndexingParam>;
using GridLayoutTestYeeIndexing3DO2 = GridLayoutTest<PHARE::SimOpts{3, 2}, GridLayoutIndexingParam>;
using GridLayoutTestYeeIndexing3DO3 = GridLayoutTest<PHARE::SimOpts{3, 3}, GridLayoutIndexingParam>;
