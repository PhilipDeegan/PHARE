...
using GridLayoutTestYee1DO1 = GridLayoutTest<PHARE::SimOpts{1, 1}, GridLayoutAllocSizeParam>;
using GridLayoutTestYee1DO2 = GridLayoutTest<PHARE::SimOpts{1, 2}, GridLayoutAllocSizeParam>;
using GridLayoutTestYee1DO3 = GridLayoutTest<PHARE::SimOpts{1, 3}, GridLayoutAllocSizeParam>;

using GridLayoutTestYee2DO1 = GridLayoutTest<PHARE::SimOpts{2, 1}, GridLayoutAllocSizeParam>;
using GridLayoutTestYee2DO2 = GridLayoutTest<PHARE::SimOpts{2, 2}, GridLayoutAllocSizeParam>;
using GridLayoutTestYee2DO3 = GridLayoutTest<PHARE::SimOpts{2, 3}, GridLayoutAllocSizeParam>;

using GridLayoutTestYee3DO1 = GridLayoutTest<PHARE::SimOpts{3, 1}, GridLayoutAllocSizeParam>;
using GridLayoutTestYee3DO2 = GridLayoutTest<PHARE::SimOpts{3, 2}, GridLayoutAllocSizeParam>;
using GridLayoutTestYee3DO3 = GridLayoutTest<PHARE::SimOpts{3, 3}, GridLayoutAllocSizeParam>;
...
INSTANTIATE_TEST_SUITE_P(AllocSize, GridLayoutTestYee1DO1,
                         ::testing::ValuesIn(createAllocSizeParam<PHARE::SimOpts{1, 1}>()));

INSTANTIATE_TEST_SUITE_P(AllocSize, GridLayoutTestYee1DO2,
                         ::testing::ValuesIn(createAllocSizeParam<PHARE::SimOpts{1, 2}>()));

INSTANTIATE_TEST_SUITE_P(AllocSize, GridLayoutTestYee1DO3,
                         ::testing::ValuesIn(createAllocSizeParam<PHARE::SimOpts{1, 3}>()));

INSTANTIATE_TEST_SUITE_P(AllocSize, GridLayoutTestYee2DO1,
                         ::testing::ValuesIn(createAllocSizeParam<PHARE::SimOpts{2, 1}>()));

INSTANTIATE_TEST_SUITE_P(AllocSize, GridLayoutTestYee2DO2,
                         ::testing::ValuesIn(createAllocSizeParam<PHARE::SimOpts{2, 2}>()));

INSTANTIATE_TEST_SUITE_P(AllocSize, GridLayoutTestYee2DO3,
                         ::testing::ValuesIn(createAllocSizeParam<PHARE::SimOpts{2, 3}>()));

INSTANTIATE_TEST_SUITE_P(AllocSize, GridLayoutTestYee3DO1,
                         ::testing::ValuesIn(createAllocSizeParam<PHARE::SimOpts{3, 1}>()));

INSTANTIATE_TEST_SUITE_P(AllocSize, GridLayoutTestYee3DO2,
                         ::testing::ValuesIn(createAllocSizeParam<PHARE::SimOpts{3, 2}>()));

INSTANTIATE_TEST_SUITE_P(AllocSize, GridLayoutTestYee3DO3,
                         ::testing::ValuesIn(createAllocSizeParam<PHARE::SimOpts{3, 3}>()));
