...
using GridLayoutFieldCenteredCoordinate1DO1
    = GridLayoutTest<PHARE::SimOpts{1, 1}, GridLayoutFieldCenteringParam>;

using GridLayoutFieldCenteredCoordinate1DO2
    = GridLayoutTest<PHARE::SimOpts{1, 2}, GridLayoutFieldCenteringParam>;

using GridLayoutFieldCenteredCoordinate1DO3
    = GridLayoutTest<PHARE::SimOpts{1, 3}, GridLayoutFieldCenteringParam>;

using GridLayoutFieldCenteredCoordinate2DO1
    = GridLayoutTest<PHARE::SimOpts{2, 1}, GridLayoutFieldCenteringParam>;

using GridLayoutFieldCenteredCoordinate2DO2
    = GridLayoutTest<PHARE::SimOpts{2, 2}, GridLayoutFieldCenteringParam>;

using GridLayoutFieldCenteredCoordinate2DO3
    = GridLayoutTest<PHARE::SimOpts{2, 3}, GridLayoutFieldCenteringParam>;

using GridLayoutFieldCenteredCoordinate3DO1
    = GridLayoutTest<PHARE::SimOpts{3, 1}, GridLayoutFieldCenteringParam>;

using GridLayoutFieldCenteredCoordinate3DO2
    = GridLayoutTest<PHARE::SimOpts{3, 2}, GridLayoutFieldCenteringParam>;

using GridLayoutFieldCenteredCoordinate3DO3
    = GridLayoutTest<PHARE::SimOpts{3, 3}, GridLayoutFieldCenteringParam>;
